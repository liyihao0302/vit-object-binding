...
from utils.score import InstanceSegmentationLoss
...
class TrainerInstance:
    def __init__(self, cfg, output_dir):
        ...
        self.criterion = InstanceSegmentationLoss(cfg)
        self.output_dir = output_dir

        # Load checkpoint if exists
        if cfg.mode == 'train_instance':
    ...
    def train(self, cfg):
        ...
        for epoch in range(self.start_epoch, cfg.trainer.max_epoch):
            ...
            for images, masks, bboxes in tqdm(self.train_dataloader):
                ...
                predicted_labels = torch.argmax(out, dim=2)
